...
class Pipeline:
    ...
    def predict_mlflow_model(self, text_input: str):
        if not self._mlflow_model:
            model_id = """REPLACE WITH YOUR ID""" # tip: model_id should look like this: a1ab9f729978489cabc903f14f70c7d3 and you can find it in the MLFlow UI (see Task 9 in test_pipeline.ipynb)
